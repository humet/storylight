...
import { createOneOffStoryAction } from "./actions";
      ...
      {step === 2 ? (
        <section className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3">
            <div className="rounded-xl border border-accent-strong bg-accent-soft p-4">
            ...
            <div className="rounded-xl border border-border bg-surface p-4 opacity-70">
              ...
              <p className="font-sans text-sm text-ink-muted text-pretty">
                A series that grows one chapter at a time. Arriving shortly.
              </p>
            </div>
          </div>
        </section>
      ...
      {step === 4 ? (
        <section className="flex flex-col gap-4">
          ...
          <Button size="lg" fullWidth onClick={start} disabled={submitting}>
            {submitting ? "Starting…" : "Start tonight's story"}
          </Button>
        </section>
      ) : null}
